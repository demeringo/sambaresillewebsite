...
<p/>
		...
		<h3>Da Krew</h3>
		<p>
		Parti d'une base Hip-Hop, le Da Krew expérimente et s'inspire de différents courants musicaux pour créer une alchimie entre performance lyrique et instruments électroniques.<br/>
		Partenaires de samba résille sur des résidendes et soirées concert, vous pouvez les écouter sur <a href="http://www.da-krew.net/" target="_blank">le site du Da Krew</a> et leur <a href="http://www.myspace.com/dakrewlegroupe" target="_blank">Myspace</a>.
		</p>
...
<p>Le portail Associatif toulousain: <a href="http://www.toulousasso.org/">www.toulousasso.org</a>
		...
		<h3>Musique Populaire Brésilienne</h3>
		<p>
		Deux sites de partitions à utiliser sans modération<br/>
		- L'excellent <a href="http://www.e-chords.com/">e-chord </a> qui permet de consulter/imprimer les partitions sans rien installer, de transposer et de visualiser les accords pour piano, guitare et cavaco.<br/>
		- Un autre très bon site: <a href="http://cifraclub.terra.com.br/">cifraclub</a> avec de nombreuses partitions et paroles (les accords sont indiqués dans le texte des chansons).
		</p>
		
		<p/>
		<h3>Les cours d'instruments de K-nard :</h3>
		<p>Les cours en vidéo pour 
<a href="http://www.dailymotion.com/video/xmlqe_jouer-le-tambourim-avec-knard" target="_blank">le tambourim</a> et <a href="http://www.dailymotion.com/video/xo9ta_tantan-tourne" target="_blank">le tan-tan</a></p>
		
		<p/>
		<h3>Les cahiers de Bando do Chorão</h3>
		<p>Des grilles harmoniques à foison pour encourager les rodas de Choro:<br/>
		<a href=" http://bando.do.chorao.free.fr/root/caderno/caderno-harmonias-vol1.htm" target="_blank">Volume 1 (pdf) </a> et <a href="http://bando.do.chorao.free.fr/root/caderno/caderno-harmonias-vol2.htm" target="_blank">Volume 2 (pdf)</a>
		</p>
		...
		<h3>Le samba dans le monde</h3>
		<p>
		Cette page serait bien incomplète si elle ne mentionnait pas le site des sambistes du monde : <a href="http://www.worldsamba.org" Target="_blank">World Samba</a> <i>(en anglais)</i>. C'est un centre de ressources contenant une foule de liens et de références pratiques pour le sambiste baladeur...
		</p>
...
http://www.musicophages.org/ (Médiatèque associative)
...
-->
	...
	<br/>
	<br/>
	<p>Si vous souhaitez modifier des infos sur cette page, contactez <a href="mailto:webmaster@samba-resille.org">webmaster@samba-resille.org</a>
	</p>
	</div>
